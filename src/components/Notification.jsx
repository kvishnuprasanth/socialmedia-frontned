...
const Notification = () => {
  ...
  return (
    <div ref={containerRef} onScroll={handleInfiniteScroll} className={`absolute right-[15rem] sm:right-[18rem] top-16 rounded-xl min-w-[300px] w-[23vw] h-[100vh] ${dark?`bg-slate-800 border-slate-700`:`bg-slate-100 border-slate-300`} z-[11] p-2 hidden ss:flex flex-col overflow-scroll border-2 pb-16`}  >
